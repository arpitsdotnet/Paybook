<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateOld.aspx.cs" Inherits="Paybook.WebUI.Invoice.CreateOld" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script type="text/javascript">
                ...
                try {
                    if (Validation_Invoice()) {
                        ...
                        var sJsonVar = {
                            ...
                            , "sInvoiceStatus_Core": <%=InvoiceStatusConst.Open%>, "sAgent_ID": $("#hfLogInUser_ID").val(), "sRemark": $("#txtRemark").val(), "sMRP": $("#txtAmount").val()
                            , "sGST_Type": sGST_Type, "sVehicleNo": $("#txtVehicleNo").val()
                        };
                        CallAjaxMethod("Invoice_Insert", sJsonVar, "Invoice_Insert_Callback");
                    }
                }
                catch (err) {
                    ShowMessage(err);
                ...
                try {
                    ...
                    if (sAgency_ID == 'NONE' && sCustomer_ID == 0) {
                        ...
                        if (sAgency_ID == "NONE") {
                            ...
                            CallAjaxMethod("Customer_SelectRemainingAmount", sJsonVar, "SelectRemainingAmount_Callback");
                        }
                    }
                }
                catch (err) {
            ...
            $("#btnExportTableData").click(function (e) {
                try {
                    ...
                    if ($("#txtDateTo").val() == "" || $("#txtDateFrom").val() == "") {
                        ReadXMLMessage("REW701", "ReadXMLMessage_Callback");
                    }
                    else {
                        ...
                        if (sAgency_ID != "0") {
                            ...
                            CallAjaxMethod("GenrateReportForAgency", sJsonVar, "GenrateReport_Callback");
                        }
                        else {
                            if (sCustomer_ID == "0") {
                                ReadXMLMessage("CUS107", "ReadXMLMessage_Callback");
        ...
        function Validation_Invoice() {
            try {
                if ($("#ddlAgency").val() == 0) {
                    ReadXMLMessage("AGES107", "ReadXMLMessage_Callback");
                    return false;
                }
                    ...
                    ReadXMLMessage("BSW017", "ReadXMLMessage_Callback");
                    return false;
                }
                else if ($("#txtAmount").val() == "" || parseFloat($("#txtAmount").val()) <= 0.0) {
                    ReadXMLMessage("PTS503", "ReadXMLMessage_Callback");
                    return false;
                }
        ...
        function Invoice_Insert_Callback(data) {
            try {
                var $Data = data.d;
                if ($Data.length > 0) {
                    if ($Data[0].ERROR != null && $Data[0].ERROR != "") {
                        ...
                        if (sAgency_ID != "0" && sAgency_ID != "NONE") {
                            var sJsonVar = { 'sAgency_ID': sAgency_ID };
                            CallAjaxMethod("Agency_SelectRemainingAmount", sJsonVar, "SelectRemainingAmount_Callback");
                        }
                        else {
        ...
        function SelectRemainingAmount_Callback(data) {
            try {
                var $Data = data.d;
                if ($Data.length > 0) {
                    if ($Data[0].ERROR != null && $Data[0].ERROR != "") {
                ...
                ShowMessage("There is an issue calling the function (SelectRemainingAmount_Callback)" + err);
            }
        }
        ...
        function AdvancePayment_Insert_Callback(data) {
            try {
                $Data = data.d;
                if ($Data.length > 0) {
                    if ($Data[0].ERROR != null && $Data[0].ERROR != "") {
                    ...
                    if ($Data[0].ERROR != null && $Data[0].ERROR != "") {
                        ...
                        if (varRowCount == varCountPayment) {
                            ...
                            if (sAgency_ID != "0" && sAgency_ID != "NONE") {
                                ...
                                CallAjaxMethod("Agency_Update_AdvancePayment", jsonVar, "Customer_Update_AdvancePayment_Callback");
                            }
                            else {
