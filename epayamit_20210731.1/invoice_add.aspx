<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="invoice_add.aspx.cs" Inherits="Paybook.WebUI.invoice_add" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="<%=Application["Path"] %>_Layouts/JS/custom_payment.js" type="text/javascript"></script>   
  <%--  <script type="text/javascript" src="<%=Application["Path"] %>_Layouts/JS/TableExport/pdfmake/pdfmake.min.js"></script>
    <script type="text/javascript" src="<%=Application["Path"] %>_Layouts/JS/TableExport/pdfmake/vfs_fonts.js"></script>  
    <script type="text/javascript" src="<%=Application["Path"] %>_Layouts/JS/TableExport/FileSaver/FileSaver.min.js"></script>
    <script type="text/javascript" src="<%=Application["Path"] %>_Layouts/JS/TableExport/tableExport.js"></script>--%>
</asp:Content>
            ...
            <div class="fwt-col l2 m2 s12">
             ...
             <div class="fwt-col l3 m3 s12" id="divSelectOperation">
                <asp:RadioButtonList ID="rbtnlSelectOperation" runat="server" ClientIDMode="Static" RepeatDirection="Horizontal" CssClass="RadioButtonNormal">
                    <asp:ListItem Value="CreateInvoice" Selected="True"> Create New Invoice </asp:ListItem>
                    <asp:ListItem Value="MakePayment"> Go for Payment </asp:ListItem>
                </asp:RadioButtonList>
            </div>
                    ...
                    <div class="fwt-padding-4">
                        ...
                        <div>
                            <asp:RadioButtonList ID="rbtn_GST_Value" runat="server" ClientIDMode="Static" RepeatDirection="Horizontal" CssClass="RadioButtonNormal">
                                <asp:ListItem Value="GST_NONE" Selected="True">None </asp:ListItem>
        ...
        <div id="irmGenrateReport" style="display: none; height: 100%; width: 100%;">
            <div class="fwt-padding-8"> 
                ...
                <button runat="server" id="btnPrint" class="fwt-btn fwt-ripple fwt-dropdown-click fwt-amber"
                    clientidmode="Static">Print</button>
