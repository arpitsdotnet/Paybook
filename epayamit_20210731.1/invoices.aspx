<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="invoices.aspx.cs" Inherits="Paybook.WebUI.invoices" %>
    ...
    <div class="fwt-container">
        ...
        <div class="fwt-padding-4">
            ...
            <div class="fwt-col l3 m3 s12" style="padding-top: 15px">
                ...
                <asp:Button ID="btnReset" runat="server" CssClass="fwt-btn fwt-purple fwt-hover-indigo"
                    Text="Reset" ClientIDMode="Static" />
                <asp:Button ID="btnSearch" runat="server" CssClass="fwt-btn fwt-green fwt-hover-indigo"
                    Text="Search" ClientIDMode="Static" />
        ...
        <div class="fwt-padding-4">
            ...
            <div class="table-Scroll" id="div_ScrolltblInvoices">
                ...
                <div id="divGridLoadingtblInvoices" style="text-align: center;">
                </div>
                <asp:Label ID="lblGridMessagetblInvoices" runat="server" CssClass="Error" ClientIDMode="Static"></asp:Label>
            </div>
        </div>
